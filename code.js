...
function save_changes(roll)
{
 ...
 //this part is for making input elements uneditable
 ...
 //this part is for changing bg color based on rating

 var x=slider.value;
 switch(x){
 case "1" : p.style.backgroundColor="#ff3300";break;
 
 case "2" : p.style.backgroundColor="#ff9900";break;
 
 case "3" : p.style.backgroundColor="#cc9900";break;
 
 case "4" : p.style.backgroundColor="#cccc00";break;
 
 case "5" : p.style.backgroundColor="#99cc00";break;
 
 }

 
 //this part is for sorting profiles based on rating
 ...
 for(var i=0;i<div.length;i++)
{
  ...
  {
   var a=div[i].querySelector('input[type="range"]').value;
   var b=div[j].querySelector('input[type="range"]').value;
   
   if(a<b)
   document.body.insertBefore(div[j],div[i]);
